...
export function EventCard({ event, language }: EventCardProps) {
  ...
  return (
    <Card className="p-4 sm:p-5 md:p-6 border-2 shadow-lg flex flex-col h-full max-h-[calc(100vh-180px)] overflow-hidden">
      ...
      <div className="flex items-center justify-center gap-1 sm:gap-2 py-4 sm:py-5 md:py-6 mb-3 sm:mb-4 border-y flex-shrink-0">
        <div className="text-center flex-shrink-0 min-w-0">
          ...
          <div className="text-sm sm:text-base text-muted-foreground font-medium mt-1 sm:mt-1.5">{labels.days}</div>
        </div>
        <div className="text-2xl sm:text-3xl md:text-4xl font-bold text-muted-foreground/40 pb-3">:</div>

        <div className="text-center flex-shrink-0 min-w-0">
          <div className="text-3xl sm:text-4xl md:text-5xl font-bold text-foreground tabular-nums leading-none">
            {String(timeElapsed.hours).padStart(2, "0")}
          </div>
          <div className="text-sm sm:text-base text-muted-foreground font-medium mt-1 sm:mt-1.5">{labels.hours}</div>
        </div>
        <div className="text-2xl sm:text-3xl md:text-4xl font-bold text-muted-foreground/40 pb-3">:</div>
        ...
        <div className="text-center flex-shrink-0 min-w-0">
          ...
          <div className="text-sm sm:text-base text-muted-foreground font-medium mt-1 sm:mt-1.5">{labels.minutes}</div>
        </div>
        <div className="text-2xl sm:text-3xl md:text-4xl font-bold text-muted-foreground/40 pb-3">:</div>
        ...
        <div className="text-center flex-shrink-0 min-w-0">
          ...
          <div className="text-sm sm:text-base text-muted-foreground font-medium mt-1 sm:mt-1.5">{labels.seconds}</div>
        </div>
      </div>
        ...
        <div className="bg-muted/30 rounded-lg p-3 sm:p-4">
          <div className="flex flex-col gap-2 sm:gap-2.5">
            <div className="flex justify-between items-baseline">
              ...
              <span className="text-sm sm:text-base text-muted-foreground">{labels.years}</span>
            </div>
            <div className="flex justify-between items-baseline">
              <span className="text-lg sm:text-xl md:text-2xl font-bold text-foreground tabular-nums">
                {detailedTime.months}
              </span>
              <span className="text-sm sm:text-base text-muted-foreground">{labels.months}</span>
            </div>
            <div className="flex justify-between items-baseline">
              <span className="text-lg sm:text-xl md:text-2xl font-bold text-foreground tabular-nums">
                {detailedTime.days}
              </span>
              <span className="text-sm sm:text-base text-muted-foreground">{labels.days}</span>
            </div>
            <div className="flex justify-between items-baseline">
              <span className="text-lg sm:text-xl md:text-2xl font-bold text-foreground tabular-nums">
                {detailedTime.hours}
              </span>
              <span className="text-sm sm:text-base text-muted-foreground">{labels.hours}</span>
            </div>
            <div className="flex justify-between items-baseline">
              <span className="text-lg sm:text-xl md:text-2xl font-bold text-foreground tabular-nums">
                {detailedTime.minutes}
              </span>
              <span className="text-sm sm:text-base text-muted-foreground">{labels.minutes}</span>
            </div>
            <div className="flex justify-between items-baseline">
              <span className="text-lg sm:text-xl md:text-2xl font-bold text-foreground tabular-nums">
                {detailedTime.seconds}
              </span>
              <span className="text-sm sm:text-base text-muted-foreground">{labels.seconds}</span>
            </div>
          </div>
        </div>
      </div>
